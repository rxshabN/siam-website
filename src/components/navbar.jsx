...
//   return (
//     <>
//       <nav className="w-full py-5 px-5 braah-one relative z-50">
...
//               <li className="uppercase text-white text-[28px] font-medium">
...
//           className="z-50 navbarbutton flex items-center gap-x-2.5 uppercase rounded-full py-0.5 px-6 font-light text-white bg-gradient-to-r from-[#2b684e] to-[#001b0c]"
//         >
//           {isOpen ? (
//             <svg
...
//         </button>
//         {isOpen && (
//           <ul className="braah-one uppercase flex flex-col items-center text-center fixed right-3 top-14 mt-2 w-48 bg-black/60 rounded-xl shadow-lg text-white space-y-2">
